...
static void update_vv_display(uint64_t *device_address, usb_talk_payload_t *payload, usb_talk_subscribe_t *sub);
...
const usb_talk_subscribe_t subscribes[] = {
    ...
    {"vv-display/-/power/set", update_vv_display, 0, "power"},
    {"vv-display/-/fve/set", update_vv_display, 0, "fve"},
    {"vv-display/-/living-room/set", update_vv_display, 0, "liv-room"},
